...
const {getStoredGithubToken, setGithubCredentials, createNewToken, githubAuthenticate, getAccessToken} = require('./lib/auth')
...
console.log(
  chalk.yellow(
    figlet.textSync('Repo Init CLI', {horizontalLayout: 'full'})
  )
)
